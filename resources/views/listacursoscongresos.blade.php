                ...
                <div class="col-lg-8 text-center">
                    ...
                    {{-- <div class="mt-4 text-white animate__animated animate__fadeInUp">
                        ...
                        <div class="popular-searches">
                            <a href="{{ route('lista.cursos.congresos', ['search' => 'Desarrollo Web']) }}"
                               class="badge bg-light text-dark me-2 mb-2 py-2 px-3 rounded-pill">Desarrollo Web</a>
                            <a href="{{ route('lista.cursos.congresos', ['search' => 'Inteligencia Artificial']) }}"
                               class="badge bg-light text-dark me-2 mb-2 py-2 px-3 rounded-pill">Inteligencia Artificial</a>
                            <a href="{{ route('lista.cursos.congresos', ['search' => 'Marketing Digital']) }}"
                               class="badge bg-light text-dark me-2 mb-2 py-2 px-3 rounded-pill">Marketing Digital</a>
                            <a href="{{ route('lista.cursos.congresos', ['search' => 'Gestión de Proyectos']) }}"
                               class="badge bg-light text-dark me-2 mb-2 py-2 px-3 rounded-pill">Gestión de Proyectos</a>
                        </div>
                    </div> --}}
                </div>
            </div>
