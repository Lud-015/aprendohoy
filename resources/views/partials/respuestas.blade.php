                    ...
                    @forelse ($pregunta->respuestas as $respuesta)
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" action="{{ route('respuestas.delete', $respuesta->id) }}" id="delete-form-{{ $respuesta->id }}" class="d-inline">
                                    @csrf
                                    @method('DELETE')
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="{{ route('respuestas.update', $respuesta->id) }}">
                            @csrf
                            @method('PUT')
    ...
    <div class="modal fade" id="crearRespuestaModal-{{ $pregunta->id }}" tabindex="-1" aria-labelledby="crearRespuestaModalLabel-{{ $pregunta->id }}" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('respuestas.storeMultiple', $pregunta->id) }}">
                        @csrf
        ...
        <div class="modal fade" id="crearRespuestaClaveModal-{{ $pregunta->id }}" tabindex="-1" aria-labelledby="crearRespuestaClaveModalLabel-{{ $pregunta->id }}" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="{{ route('respuestas.storeRespuestasClave', $pregunta->id) }}">
                            @csrf
