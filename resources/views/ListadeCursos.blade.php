                    ...
                    <tbody>
                        ...
                        @forelse ($cursos as $cursos)
                            <tr>
                                ...
                                <td>{{ $cursos->nivel ? ucfirst(strtolower($cursos->nivel->nombre)) : 'N/A' }}</td>
                                ...
                                <td
                                    ...
                                    {{ $cursos->edad_dirigida ? ucfirst(strtolower($cursos->edad_dirigida->nombre)) : 'N/A' }}
                                </td>
                                ...
                                <td>
                                    <a href="{{ route('quitarCurso', [$cursos->id]) }}"
