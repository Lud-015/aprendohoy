                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="collapse show" id="filtrosCollapse">
                            <div class="card-body">
                                <form method="GET" action="{{ route('historialAsistencias', $cursos->id) }}" id="filtrosForm">
                                    <div class="row">
                                        <div class="col-md-4">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-12">
                                            ...
                                            <a href="{{ route('historialAsistencias', $cursos->id) }}" class="btn btn-secondary">
                                    ...
                                    <td colspan="{{ auth()->user()->hasAnyRole(['Docente', 'Administrador']) ? 5 : 4 }}"
                                        ...
                                        <div class="empty-state">
                                            ...
                                            @if(request()->hasAny(['busqueda', 'fecha_desde', 'fecha_hasta', 'tipo_asistencia']))
                                                <a href="{{ route('historialAsistencias', $cursos->id) }}" class="btn btn-outline-primary">
                                                    <i class="fas fa-eraser"></i> Limpiar Filtros
                                                </a>
                                            @endif
                                        </div>
