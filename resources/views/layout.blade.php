    ...
    <div class="container-fluid">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
            <div class=" dropdown-header noti-title">
              <h6 class="text-overflow m-0">Bienenido!</h6>
            </div>
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav mb-md-3">
          <li class="nav-item">
            <a class="nav-link" href="https://www.facebook.com/profile.php?id=100063510101095&mibextid=ZbWKwL">
              <i class="ni ni-collection"></i> Facebook
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="https://instagram.com/fundeducarparalavida?igshid=MzRlODBiNWFlZA==">
              <i class="ni ni-camera-compact"></i> Insagram
            </a>
          </li>
          {{-- <li class="nav-item">
        ...
        <div class="row align-items-center justify-content-xl-between">
          <div class="col-xl-6">
            <div class="copyright text-center text-xl-left text-muted">
              {{-- &copy; 2023 <a href="https://educarparalavidafu.wixsite.com/educarparalavida" class="font-weight-bold ml-1" target="">Fundacion para educar para la vida</a> --}}
            </div>
          </div>
          <div class="col-xl-6">
