                        ...
                        <table class="table table-striped table-hover" id="rankingTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $intento->finalizado_en ? $intento->finalizado_en->format('d/m/Y H:i') : 'Salió del cuestionario' }}</td>
                                    <td>
                                        <a href="{{ route('cuestionarios.revisarIntento', [$cuestionario->id, $intento->id]) }}" class="btn btn-outline-primary btn-sm">
                                            <i class="bi bi-eye-fill"></i> Revisar
                                        </a>
                                        <form action="{{ route('intentos.eliminar', $intento->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
