                            ...
                            <form action="{{ route('editarCursoPost', $cursos->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        @else
                                            <input type="hidden" name="fecha_ini"
                                                value="{{ $cursos->fecha_ini ? \Carbon\Carbon::parse($cursos->fecha_ini)->format('Y-m-d\TH:i') : '' }}">
                                            <input type="text" class="form-control"
                                                value="{{ \Carbon\Carbon::parse($cursos->fecha_ini)->format('d/m/Y H:i') }}"
                                                disabled>
                                        @endif
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        @else
                                            <input type="hidden" name="fecha_fin"
                                                value="{{ $cursos->fecha_fin ? \Carbon\Carbon::parse($cursos->fecha_fin)->format('Y-m-d\TH:i') : '' }}">
                                            <input type="text" class="form-control"
                                                value="{{ \Carbon\Carbon::parse($cursos->fecha_fin)->format('d/m/Y H:i') }}"
                                                disabled>
                                        @endif
                                    </div>
                                ...
                                @if (auth()->user()->hasRole('Administrador'))
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-3">
                                            <label for="precio" class="form-label">Precio (en USD)</label>
