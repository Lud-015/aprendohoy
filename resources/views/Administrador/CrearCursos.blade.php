        ...
        <form class="row g-3" action="{{ route('CrearCursoPost') }}" method="POST">
            ...
            <div class="col-12 border p-4 rounded">
                ...
                <div class="row mb-3">
                    <!-- Duración -->
                    <div class="col-md-3">
                        <label for="duracion" class="form-label">Duración (en horas) <span class="text-danger">*</span></label>
                        <input type="number" name="duracion" id="duracion" class="form-control" value="{{ old('duracion') }}" min="1" required>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="cupos" id="cupos" class="form-control" value="{{ old('cupos') }}" min="1" required>
                    </div>

                    <!-- Precio -->
                    <div class="col-md-3">
                        <label for="precio" class="form-label">Precio (en USD) <span class="text-danger">*</span></label>
