                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <form id="form-activar-{{ $expositor->id }}" method="POST"
                                    action="{{ route('expositores.restore', $expositor->id) }}" class="form-activar d-inline">
                                    @csrf
                                ...
                                <form id="form-eliminar-{{ $expositor->id }}" method="POST"
                                    action="{{ route('expositores.destroy', $expositor->id) }}"
                                ...
                                <div class="modal fade" id="editarExpositorModal" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <form id="formEditarExpositor" action="{{ route('expositores.update', $expositor->id) }}" method="POST"
