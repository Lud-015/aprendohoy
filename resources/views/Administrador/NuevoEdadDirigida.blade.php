...
@section('content')
    ...
    <form method="POST" action="{{route('guardarRangodeEdad')}}">
        ...
        <div class="card-body p-3">
            ...
            <div class="row">
                <div class="col-md-12 mb-md-0 mb-4">
                    <h3>Ingrese Los parámetros de categoria de edad</h3>
                    <div class="card card-body border card-plain border-radius-lg d-flex align-items-center flex-row">

                        <input type="text" name="nombre" placeholder="Nombre de edad dirigida">  &nbsp;De&nbsp; <input type="number" name="edad1"> &nbsp;hasta&nbsp; <input type="number"name="edad2">
            ...
            <input class="btn btn-lg btn-success" type="submit" value="Crear">
