    ...
    <div class="container mt-4">
        ...
        <div class="modal fade" id="editarYoutubeModal" tabindex="-1" aria-labelledby="editarYoutubeModalLabel"
            ...
            <div class="modal-dialog">
                <form method="POST" action="{{ route('cursos.updateYoutube', $curso->id) }}">
                    @csrf
                    @method('PUT')
                ...
                @forelse ($imagenes as $imagen)
                    <tr>
                        ...
                        <td>
                            ...
                            @if (!$imagen->activo)
                                <form method="POST" action="{{ route('curso-imagenes.restore', $imagen->id) }}"
                            ...
                            @else
                                ...
                                <form id="form-inactivar-{{ $imagen->id }}"
                                    action="{{ route('curso-imagenes.destroy', $imagen->id) }}" method="POST"
                                    style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
